...
<div class="row">
	<div class="span6">
	<h1>
	<a class="logo" href="home.html"><span>Grocery2Go</span>
    ...
    <div class="container">
      ...
      <h3>Fresh Meat</h3>
        <div class="row-fluid">
          ...
          ?>
              <div id="shopping-cart">
                  <div class="txt-heading">
                      ...
                      <a id="btnEmpty" href="drinks.php?action=empty"><img
              ...
              foreach ($cartItem as $item) {
                  ?>
                          ...
                          <div class="cart-info action">
                              <a
                                  href="drinks.php?action=remove&id=<?php echo $item["cart_id"]; ?>"
          ...
          <?php require_once "drink-list.php"; ?>
